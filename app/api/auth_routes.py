...
import json
from flask import Blueprint, jsonify, session, request, redirect, abort
...
client_secrets = {
    "web": {
        ...
        "redirect_uris": [
            "https://galacticogear.onrender.com/api/auth/google",
        ]
    }
}
...
flow = Flow.from_client_secrets_file(
    ...
    redirect_uri="https://galacticogear.onrender.com/api/auth/google"
)
...
def oauth_login():
    ...
    # I recommend that you print this value out to see what it's generating.
    ...
    session["state"] = state
    # This line technically will enact the SECOND and THIRD lines of our flow chart.
...
def callback():
    ...
    # This will send the final redirect to our user's browser. As depicted in Line 8 of the flow chart!
